...
Most of the time, you do not need to take special steps before this test. Tell your health care provider the medicines you are taking, including the ones without a prescription. Some medicines may change the test results.
...
A low number of WBCs is called leukopenia. A count less than 4,500 cells per microliter (4.5 × 10⁹/L) is below normal.
...
* Cancer treating medicines, or other medicines (see list below)
* Certain autoimmune disorders such as systemic lupus (SLE)
...
* Severe emotional or physical stress (such as from an injury or surgery) - however this usually elevates the white blood cell count
...
### Medicines that may lower your WBC count include:
...
### Medicines that may increase WBC counts include:
